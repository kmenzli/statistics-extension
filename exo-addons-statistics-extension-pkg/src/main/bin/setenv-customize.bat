...
SET CATALINA_OPTS=%CATALINA_OPTS% -DdbServerType=embed -DdbServerHost=127.0.0.1 -DdbServerPort=27777 -DdbName=chat -DdbAuthentication=false -DdbUser=admin -DdbPassword=pass